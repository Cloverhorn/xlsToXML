...
const aviaHeader = document.createElement('h2')
const trainHeader = document.createElement('h2')
const hotelHeader = document.createElement('h2')

function createElements() {
  aviaHeader.innerHTML = 'Авиабилеты, класс'
  app.appendChild(aviaHeader)
  app.appendChild(aviaList)
  app.appendChild(textAviaDisplay)
  
  trainHeader.innerHTML = 'Ж/д билеты, класс'
  app.appendChild(trainHeader)
  app.appendChild(trainList)
  app.appendChild(textTrainDisplay)
  
  hotelHeader.innerHTML = 'Гостиница'
  app.appendChild(hotelHeader)
